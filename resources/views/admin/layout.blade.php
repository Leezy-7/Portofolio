    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-admin-gray text-white">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.contact.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white {{ request()->routeIs('admin.contact.*') ? 'bg-gray-700 text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ url('/') }}" target="_blank" class="bg-admin-blue text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
                            View Portfolio
                        </a>
