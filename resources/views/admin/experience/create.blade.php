...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold">Add Work Experience</h3>
                <p class="text-gray-600 mt-1">Add a new entry to your professional experience</p>
            </div>
    ...
    <form action="{{ route('admin.experience.store') }}" method="POST" class="p-6 space-y-6">
        @csrf
